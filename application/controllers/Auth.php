...
class Auth extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->database('cradle', TRUE);
	...
	public function index()
	{
		...
		else
		{
			...
			if($this->session->old_url)
			{
				redirect($this->session->old_url);
			}
			else {
				{
					redirect('welcome');
  	...
  	elseif (!$this->ion_auth->is_admin()) // remove this elseif if you want to enable this for non-admins
		{
			...
			$this->session->set_flashdata('message', 'Access denied. You must be an administrator to view this page.');
